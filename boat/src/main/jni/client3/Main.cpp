...
extern "C" JNIEXPORT void JNICALL Java_cosine_boat_version3_BoatInputEventSender_send(JNIEnv* env, jclass clazz, jlong time, jint type, jint p1, jint p2){
...
extern "C" void setCursorMode(int mode){
	...
	if (class_BoatInputEventSender == 0){
		__android_log_print(ANDROID_LOG_ERROR, "BoatClient", "Failed to find class: cosine/boat/version3/BoatInputEventSender.");
		abort();
	}
...
extern "C" JNIEXPORT jint JNI_OnLoad(JavaVM* vm,void*)
{
	...
	jclass class_BoatInputEventSender = env->FindClass("cosine/boat/version3/BoatInputEventSender");
