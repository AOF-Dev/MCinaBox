...
import com.aof.mcinabox.definitions.map.MouseMap;

import java.util.HashMap;

import static com.aof.mcinabox.gamecontroller.codes.BoatKeycodes.*;
import static com.aof.mcinabox.gamecontroller.codes.BoatMousecodes.*;

public class XKeyMap implements KeyMap , AppEvent , MouseMap {
