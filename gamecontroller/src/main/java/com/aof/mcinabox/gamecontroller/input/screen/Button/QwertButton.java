...
public class QwertButton extends BaseButton {
    ...
    public String getCharNone() { return char_none; }
    public void setCharNone(String charName) { char_none = charName; }
    public String getCharShift(){ return char_shift; }
    public void setCharShift(String charName) { char_shift = charName; }
    public String getCharCaps() { return char_capslock; }
    public void setCharCaps(String charName) { char_capslock = charName; }
}
